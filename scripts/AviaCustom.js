function demopage_switchslider(){var a=window.location.href.substring(window.location.href.indexOf('?')+8);

if(a!==undefined&&a!==''&&window.location.href.indexOf('?')>0){$('.aviaslider').attr('id',a)}}$(document).ready(function(){
